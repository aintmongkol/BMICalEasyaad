...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button_cal = (Button) findViewById(R.id.button);
    ...
    private void calBMI(){
        EditText textw = (EditText)findViewById(R.id.editText);
        EditText texth = (EditText)findViewById(R.id.editText2);
